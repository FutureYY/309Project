...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline(
        [
            node(
                func=split_data,
                inputs=["processed_data", "parameters:split_data"],
            ...
            node(
                ...
                inputs=[["X_train", "X_test", "y_train"], "parameters:random_forest_params"],
                outputs="y_pred_rfc", 
            ...
            node(
                ...
                inputs=[["X_train", "X_test", "y_train_"], "parameters:binary_logistic_params"],
                outputs="y_pred_blr",
            ...
            node(
                ...
                inputs=[["X_train", "X_test", "y_train"], "parameters:gradient_boosting_params"],
                outputs="y_pred_gbc",
